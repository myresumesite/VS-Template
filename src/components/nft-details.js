...
<h2 className="logotype" style={{fontSize:'240%', textAlign:'center', margin:'0', textTransform:'none',  background: 'rgba(0,0,0,0.75)', padding:'.5rem', borderRadius:'12px 12px 0 0'}}>MyResume Website Applications </h2>
  ...
  <br />
    ...
    <TabPanel style={{width:'100%', background: 'rgba(0,0,0,0.75)', padding:'2rem', borderRadius:'12px'}}>
            <strong style={{fontSize:'1.5rem'}}>MyResume sites are virtually hack-proof</strong><br /><br />
            <p>Because MyResume sites are built using a new method of distributed cloud-based hosting of static text and graphic files there is no server to be hacked. MyResume sites are pre-rendered web applications that build the site contents ahead of time and then served as basic media files and assembled in the site visitors browser.
            <br />
            <br />
